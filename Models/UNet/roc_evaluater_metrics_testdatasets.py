...
class Evaluate(object):
    ...
    def f1score(self):            
        ...
        with open('./evaluation_results/testdatasets_evaluation_metrics/unet_roc_evaluationmetrics_test.txt', 'a')as f:
        ...
        with open('./evaluation_results/testdatasets_evaluation_metrics/unet_roc_evaluationmetrics_test.csv','a', newline = '') as f:
...
if __name__ == "__main__":
    ...
    header = ['image_name', 'TP', 'TN', 'FP', 'FN','FPR','TPR','Precion','Recall','F1score']
        ...
        # open the file in the write mode
    with open('./evaluation_results/testdatasets_evaluation_metrics/unet_roc_evaluationmetrics_test.csv','w', newline = '') as f:
            # create the csv writer
            writer = csv.writer(f)
            #data = [image_name, TP, TN, FP, FN,fpr, tpr, prec, rec, f1score]
            # write a row to the csv file
    ...
    f = open('./evaluation_results/testdatasets_evaluation_metrics/unet_mean_roc_evaluation_metrics_test.txt', 'w')
